...
var Results = {
  ...
  show: function(txt, word) {
    if (Board.gameOver) {
      Results.title.textContent = Board.won?'Great Job!':'Nice Try!';
      Results.word.textContent = "Today's word is: " + wod.word;
      ...
      Results.cEx.innerHTML = wod.exampleCT;
